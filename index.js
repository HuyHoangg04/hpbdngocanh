const contentLetterSrart_actived = "Xin chào Ngọc Ánh (mickey) lại là anh đây a đứng đây chờ em từ chiều hehe." //Lời mở đầu cho bức thư
const mainContentLetter = "Chúc em tuổi 19 luôn hạnh phúc, xinh đẹp thì em có đủ ròi và luôn nhiệt huyết trong học tập, công việc nha (anh chưa biết chèn bó hoa nên nào gặp tính sau nhá :))." //Nội dung của bức thư
